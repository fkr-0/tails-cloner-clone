...
def admin_password_is_set() -> bool:
    """Returns True if the admin password is set, False otherwise."""
    tails_greeter_sudoers_file = "/etc/sudoers.d/tails-greeter"
    return os.path.exists(tails_greeter_sudoers_file)
